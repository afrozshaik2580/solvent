    ...
    return (
        ...
        <div className="centered">  */}
           <div className="text-center"> 
            <p className="fnt-sz1 ">Your One-Stop Hub for <br/> Digital Success</p>
            {/* <p className='fnt-sz2'>
...
<div className="dp-gt mr-nt2">   
 <img src="./assets/sm-icon.png" alt="Snow"  style={{ width: '25px',height:'25px' }}/> 
<p className='text-start'>Website Design and Development</p></div>
<div className="dp-gt">   
 <img src="./assets/sm-icon.png" alt="Snow"  style={{width: '25px',height:'25px' }}/> 
<p className='text-start'>ui/ux Design</p></div>
            </div>
          </div>
        </div>
